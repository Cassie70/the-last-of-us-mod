...
public class NailBombItem extends Item implements ProjectileItem {
    public static float POWER = 1.0F;

    public NailBombItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult use(Level level, Player user, InteractionHand hand) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            Projectile.spawnProjectileFromRotation(NailBombEntity::new, serverLevel, itemStack, user, 0.0F, POWER, 1.0F);
        }
    ...
    public Projectile asProjectile(Level level, Position pos, ItemStack stack, Direction direction) {
        return new NailBombEntity(level, pos.x(), pos.y(), pos.z(), stack);
    }
}
