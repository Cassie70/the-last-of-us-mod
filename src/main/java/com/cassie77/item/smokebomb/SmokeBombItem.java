...
public class SmokeBombItem extends Item implements ProjectileItem {
    ...
    public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
        return new SmokeBombEntity(world, pos.getX(), pos.getY(), pos.getZ(), stack);
    }
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        if (world instanceof ServerWorld serverWorld) {
            ProjectileEntity.spawnWithVelocity(SmokeBombEntity::new, serverWorld, itemStack, user, 0.0F, POWER, 1.0F);
        }
