...
public class MycotoxinSacItem extends Item implements ProjectileItem {
    ...
    public MycotoxinSacItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        if (world instanceof ServerWorld serverWorld) {
            ProjectileEntity.spawnWithVelocity(MycotoxinSacEntity::new, serverWorld, itemStack, user, 0.0F, POWER, 1.0F);
        }
    ...
    public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
        return new MycotoxinSacEntity(world, pos.getX(), pos.getY(), pos.getZ(), stack);
    }
}
